...
Analysis of 25,122 pull requests, 430,613 IRC messages, and 17 years of data tells the merge-authority story. The top three merger accounts control 81.1% of all-time historical merges, with Wladimir J. van der Laan at 34.8%, Michael Ford at 25.8%, and Marco Falke at 20.5%. In the 2022+ window (5,747 merged PRs) the top merger takes 50.2%, the top two take 70.4%, and the top three take 82.2%. Those windows are not interchangeable with Brink's 56% for calendar year 2025. The authorship Gini is 0.851 historical / 0.834 recent. Power is not distributing over time. Top-10 authorship increased from 42.7% to 47.8%. Of 7,827 contributors across the project's history, 90.7% have exited with no activity in the past year of the dump. Named merger counts, author funnels, and release-signing shares live in *[Who Controls Bitcoin, §II](/articles/bitcoin-governance#ii-the-merge-authority-structure)*. The contributor count is not the governance count, and one does not imply the other.

### Fallacy 1.1: "The process has improved, therefore the structural problem is being addressed"

Process improvements are real. Zero-review merges dropped from 30.3% to 3.3%. First-review clocks are nearly equal (12.3 hours for maintainers, 12.4 for everyone else). These are genuine workflow gains. The self-merge rate, however, is **25.5%** of 9,793 maintainer-authored merges (95% CI 24.7–26.4). Raw maintainer versus non-maintainer merge rates of about 80% against 55% overstate the gap, because most of it is self-merge privilege. Peer-merge rates, excluding self-merges, are about 59% against 54% all-time, widening to about 63% against 51% since 2022. The review weight bias between maintainers and non-maintainers has held at 5.5 to 1. Top-10 authorship increased. The authorship Gini is essentially unchanged. Non-maintainers wait 1.41× longer to merge. The oligarchy got more efficient at processing pull requests and the concentration of authority did not move. **Those are two different things.**

### Fallacy 1.2: "Maintainers are just janitors, not decision-makers"

This framing appeared in mainstream Bitcoin commentary as early as 2018 and has been repeated since. The data does not support it. Maintainers self-merge **25.5%** of their own pull requests, and **45.1%** of those self-merges carry zero reviews (**11.6%** of all maintainer-merged PRs). One historical maintainer self-merged 77.1% of his own pull requests. Five maintainers with over 1,200 merges between them have never self-merged. The "it is ordinary workflow" defense has to explain why most maintainers decline. Merge authority over the lineage that almost all economic nodes run **is not a janitorial function** by any honest definition of the term.
...
Rough consensus is defined and invoked by the same maintainers who close pull requests, which means there is no external arbiter, no defined threshold, and no appeal mechanism. The same CONTRIBUTING.md file says there is "no particular concept of 'Bitcoin Core developers' in the sense of privileged people," and then requires consensus changes to have "widely perceived technical consensus... based on the judgement of the maintainers." The first sentence is process culture. The second is who closes the question.

Jon Atack argued on PR [#26868](https://github.com/bitcoin/bitcoin/pull/26868) (2023-01-13) that outsiders overestimate maintainers as gatekeepers rather than as people implementing the rough consensus of reviewers, and undervalue the reviewers who shape it. Long-term reviewers do shape what gets attention. That does not make the closing mechanism an external process. If the people who define sufficient consensus are the same people who merge, invoking rough consensus as a legitimizing mechanism is circular.

The stronger evidence is who can close the file. Pair-level reviewer cohesion exists, but the joint-appearance counts are too small to treat as a voting machine. What is not small is merge share: one account lands 50.2% of 2022+ merges, three land 82.2%, and the implementation PR for package relay was titled `[NO MERGE]` until maintainers declared rough consensus on approach. The outcome is not emerging from an external process. The process is ratifying a judgment the merge key already holds.
